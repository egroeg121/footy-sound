...
Welcome to `footy-sound` contributor's guide.
...
If you experience bugs or general issues with `footy-sound`, please have a look
...
You can help improve `footy-sound` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`footy-sound` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `footy-sound`'s files. While this mechanism can
...
```
conda create -n footy-sound python=3 six virtualenv pytest pytest-cov
conda activate footy-sound
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/footy-sound.git
   cd footy-sound
   ```
...
5. Install [pre-commit]:
   ...
   `footy-sound` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/footy-sound
[issue tracker]: https://github.com/<USERNAME>/footy-sound/issues
